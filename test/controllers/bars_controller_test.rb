...
class BarsControllerTest < ActionController::TestCase
  ...
  test "should create bar" do
    assert_difference('Bar.count') do
      post :create, bar: { address: @bar.address, email: @bar.email, name: @bar.name, password: @bar.password }
    end
  ...
  test "should update bar" do
    patch :update, id: @bar, bar: { address: @bar.address, email: @bar.email, name: @bar.name, password: @bar.password }
    assert_redirected_to bar_path(assigns(:bar))
  end
